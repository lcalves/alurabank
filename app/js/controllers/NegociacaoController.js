System.register(["./../service/NegociacaoService", "../views/index", "../models/index", "../helpers/decorators/index", "../helpers/Utils"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    Utils_1.imprime(this._negociacoes, negociacao);
                    this._negociacoesView.update(this._negociacoes);
